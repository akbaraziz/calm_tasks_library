...
if (Check-DomainExistance){
  ...
  Configure-ActiveDirectory -DomainName "@@{DOMAIN}@@" -Password "@@{DomainAdmin.secret}@@" -DomainMode $DomainMode -ForestMode $DomainMode -DomainType "@@{DOMAIN_TYPE}@@" -ChildDomainName "@@{CHILD_DOMAIN}@@"
}
