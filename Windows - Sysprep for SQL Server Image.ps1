...
# set location
Set-Location C:\sql_server_2016_install\customizations

# Install SQL with sysprep
Invoke-Command {
    c:\sql_server_2016_install\setup.exe /qs /ACTION=PrepareImage /ConfigurationFile=c:\sql_server_2016_install\customizations\imageprep_ConfigurationFile.INI /IACCEPTSQLSERVERLICENSETERMS
}
